...
public class JobRepository : IJobRepository
{
    ...
    public JobRepository(string connectionString) => this.connectionString = connectionString;
    ...
    // If I wasn't going to replace this with RabbitMQ and MassTransit, I would write a stored procedure to handle this.
