...
namespace Dflat.Application.UnitTests.Services.Tests
{
    ...
    public class FileCollectionCompareTests
    {
        ...
        private List<File> group1 = null;   // 3 files
        private List<File> group2 = null;   // 5 files
        private List<File> group3 = null;   // 7 files
        private List<File> group1modified = null; // files from group1: first file different size, second file, different time, third file both different
